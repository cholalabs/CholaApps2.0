...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	<head>
    	...
    	<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/blueprint/plugins/chola-nav/screen.css" type="text/css" media="screen" />
	...
	<body>
		<div class="container">
			<hr class="space" />
			<div class="chola-header span-16 append-1">
				<h1><?php echo $app->getCfg('sitename'); ?></h1>
			</div>
			<?php if($this->countModules('atomic-search')) : ?>
				<div class="chola-search span-7 last">
		...
		<div class="container">
			...
			<div class="chola-footer span-16 append-1">
				<hr />
