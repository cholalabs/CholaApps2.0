...
class plgEditorCodemirror extends JPlugin
{
	...
	{
		return "document.getElementById('$id').value = Chola.editors.instances['$id'].getCode();\n";
	}
	...
	{
		return "Chola.editors.instances['$id'].getCode();\n";
	}
	...
	{
		return "Chola.editors.instances['$id'].setCode($content);\n";
	}
	...
	public function onGetInsertMethod()
	{
		...
		if (!$done)
		{
			...
			$js = "\tfunction jInsertEditorText(text, editor) {
					Chola.editors.instances[editor].replaceSelection(text);\n
			}";
	...
	public function onDisplay($name, $content, $width, $height, $col, $row, $buttons = true, $id = null, $asset = null, $author = null, $params = array())
	{
		...
		$html[] = 'Chola.editors.instances[\''.$id.'\'] = editor;';
		$html[] = '})()';
		$html[] = '</script>';
