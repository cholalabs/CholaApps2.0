...
/**
 * Cholapps master extension plugin.
 *
 * @package		Chola.Plugin
 * @subpackage	Extension.Chola
 * @since		1.6
 */
class plgExtensionChola extends JPlugin
{
	/**
	...
	private function processUpdateSites()
	{
		...
		else
		{
			...
			if (strlen($data))
			{
				...
				$this->addUpdateSite(JText::_('PLG_EXTENSION_CHOLA_UNKNOWN_SITE'), 'extension', $data, true);
			}
		}
	}
}
