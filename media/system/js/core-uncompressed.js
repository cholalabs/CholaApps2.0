...
// Only define the Chola namespace if not defined.
if (typeof(Chola) === 'undefined') {
	var Chola = {};
}

Chola.editors = {};
// An object to hold each editor instance on page
Chola.editors.instances = {};

/**
 * Generic submit form
 */
Chola.submitform = function(task, form) {
	if (typeof(form) === 'undefined') {
		form = document.getElementById('adminForm');
		/**
		 * Added to ensure Chola 1.5 compatibility
		 */
		if(!form){
...
Chola.submitbutton = function(pressbutton) {
	Chola.submitform(pressbutton);
}

/**
 * Custom behavior for JavaScript I18N in Cholapps 1.6
 *
 * Allows you to call Chola.JText._() to get a translated JavaScript string pushed in with JText::script() in Chola.
 */
Chola.JText = {
	strings: {},
	'_': function(key, def) {
 ...
 */
Chola.replaceTokens = function(n) {
 ...
 * libraries/chola/html/html/grid.php
 *
 * @param isitchecked
 * @return
 */
...
/**
 * USED IN: libraries/chola/html/toolbar/button/help.php
 *
...
/**
 * USED IN: libraries/chola/html/html/grid.php
 */
