...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	...
	<body>
		<div id="header1">
			<div id="header2">
				<div id="header3">
					<span class="logo"><a href="http://www.chola.org" target="_blank"><img src="template/images/logo.png" alt="Cholapps" /></a></span>
					<span>Cholapps <?php echo JVERSION; ?> <?php echo JText::_('INSTL_INSTALLATION') ?></span>
				</div>
			</div>
		</div>
		...
		<div id="copyright">
			<?php $chola= '<a href="http://www.chola.org">Cholapps&#174;</a>';
			echo JText::sprintf('JGLOBAL_ISFREESOFTWARE', $chola) ?>
		</div>
	</body>
</html>
