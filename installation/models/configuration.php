...
/**
 * Install Configuration model for the Chola Core Installer.
 *
 * @package		Chola.Installation
 * @since		1.6
 */
class JInstallationModelConfiguration extends JModel
{
	...
	function _createConfiguration($options)
	{
		...
		$registry->set('helpurl', 'http://help.chola.org/proxy/index.php?option=com_help&amp;keyref=Help{major}{minor}:{keyref}');
