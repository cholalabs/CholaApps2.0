...
abstract class JLoader
{
	...
	public static function import($filePath, $base = null, $key = 'libraries.')
	{
		...
		if (!isset(JLoader::$paths[$keyPath]))
		{
			...
			if (strpos($filePath, 'chola.') === 0)
			{
				// If we are loading a chola class prepend the classname with a capital J.
			...
			{
				// If it is not in the chola namespace then we have no idea if
