...
class JDocumentRendererHead extends JDocumentRenderer
{
	...
	public function fetchHead(&$document)
	{
		...
		if (count(JText::script())) {
			...
			$buffer .= $tab.$tab.$tab.'if (typeof Chola == \'undefined\') {'.$lnEnd;
			$buffer .= $tab.$tab.$tab.$tab.'Chola = {};'.$lnEnd;
			$buffer .= $tab.$tab.$tab.$tab.'Chola.JText = strings;'.$lnEnd;
			$buffer .= $tab.$tab.$tab.'}'.$lnEnd;
			$buffer .= $tab.$tab.$tab.'else {'.$lnEnd;
			$buffer .= $tab.$tab.$tab.$tab.'Chola.JText.load(strings);'.$lnEnd;
			$buffer .= $tab.$tab.$tab.'}'.$lnEnd;
			$buffer .= $tab.$tab.'})();'.$lnEnd;
			$buffer .= $tab.'</script>'.$lnEnd;
		}
