...
/**
 * Base class for a Cholapps application.
 *
...
class JApplication extends JObject
{
	...
	public function redirect($url, $msg='', $msgType='message', $moved = false)
	{
		...
		if (headers_sent()) {
			...
			$document = JFactory::getDocument();
			jimport('chola.environment.browser');
			...
			elseif (!$moved and $navigator->isBrowser('konqueror')) {
				// WebKit browser (identified as konqueror by Cholapps) - Do not use 303, as it causes subresources reload (https://bugs.webkit.org/show_bug.cgi?id=38690)
	...
	public function login($credentials, $options = array())
	{
		...
		jimport('chola.user.authentication');
	...
	static public function getRouter($name = null, array $options = array())
	{
		...
		jimport('chola.application.router');
	...
	public function getPathway($name = null, $options = array())
	{
		...
		jimport('chola.application.pathway');
