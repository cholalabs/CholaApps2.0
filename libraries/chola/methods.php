...
{
	/**
	 * Translates an internal Chola URL to a humanly readible URL.
	 *
	 * @param	string	Absolute or Relative URI to Chola resource.
...
class JText
{
	 ...
	 * @example	<script>alert(Chola.JText._('<?php echo JText::_("JDEFAULT", array("script"=>true));?>'));</script> will generate an alert message containing 'Default'
	 ...
	 * @example	<script>alert(Chola.JText._('<?php echo JText::plural("COM_PLUGINS_N_ITEMS_UNPUBLISHED", 1, array("script"=>true));?>'));</script> will generate an alert message containing '1 plugin successfully disabled'
