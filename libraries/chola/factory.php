...
abstract class JFactory
{
	...
	{
		if (!self::$application) {
			jimport('chola.application.application');
	...
	public static function getXMLParser($type = '', $options = array())
	{
		...
		switch (strtolower($type))
		{
			...
			case 'simple':
				...
				jimport('chola.utilities.simplexml');
				$doc = new JSimpleXML();
				break;
	...
	{
		jimport('chola.utilities.xmlelement');
	...
	{
		jimport('chola.registry.registry');
	...
	private static function _createDocument()
	{
		...
		//Keep backwards compatibility with Cholapps 1.0
	...
	{
		jimport('chola.filesystem.stream');

		// Setup the context; Cholapps UA and overwrite
		$context = array();
