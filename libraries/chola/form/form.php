...
/**
 * Form Class for the Chola Framework.
 *
...
class JForm
{
	 ...
	 * the form control is set to 'chola' however, the fields would be rendered like:
	 * <input name="chola[foo]" /> and <input name="chola[bar]" />.
	 *
