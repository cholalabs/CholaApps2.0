...
jimport('chola.mail.helper');

/**
 * Email Class.  Provides a common interface to send email from the Cholapps Framework
 *
 * @package		Chola.Framework
 * @subpackage	Mail
 * @since		1.5
...
class JMail extends PHPMailer
{
	...
	public function __construct()
	{
		...
		$this->SetLanguage('chola', JPATH_LIBRARIES.'/phpmailer/language/');
	}
	 ...
	 * values, use an id string that is not 'Chola'.
	 *
	 ...
	 * @since	1.5
	 */
	public static function getInstance($id = 'Chola')
	{
		static $instances;
