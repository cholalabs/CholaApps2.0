	...
	public static function uploader($id='file-upload', $params = array(), $upload_queue='upload-queue')
	{
		...
		$onFileSuccess = '\\function(file, response) {
			...
			if (json.get(\'status\') == \'1\') {
				...
				file.info.set(\'html\', \'<strong>\' + Chola.JText._(\'JLIB_HTML_BEHAVIOR_UPLOADER_FILE_SUCCESSFULLY_UPLOADED\') + \'</strong>\');
			} else {
				file.element.addClass(\'file-failed\');
				file.info.set(\'html\', \'<strong>\' +
					Chola.JText._(\'JLIB_HTML_BEHAVIOR_UPLOADER_ERROR_OCCURRED\', \'An Error Occurred\').substitute({ error: json.get(\'error\') }) + \'</strong>\');
			}
		}';
		...
		$opt['typeFilter']			= (isset($params['types'])) ? '\\'.$params['types'] : '\\{Chola.JText._(\'JLIB_HTML_BEHAVIOR_UPLOADER_ALL_FILES\'): \'*.*\'}';
