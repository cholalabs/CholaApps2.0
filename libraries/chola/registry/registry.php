...
class JRegistry
{
	 ...
	 *
	 * @param	string	Registry path (e.g. chola.content.showauthor)
	 * @return	boolean
	 * @since	1.6
	 */
	...
	/**
	 * This method is added as an interim solution for API references in Cholapps 1.6 to the JRegistry
